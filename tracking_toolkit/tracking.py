...
def init_handles():
    ...
    action_handles = {
        ...
        # Finger values (Valve Index/Knuckles compatible action paths)
        "l_thumb": _get_action_handle("/actions/legacy/in/Left_Finger_Thumb_Value"),
        "l_index": _get_action_handle("/actions/legacy/in/Left_Finger_Index_Value"),
        "l_middle": _get_action_handle("/actions/legacy/in/Left_Finger_Middle_Value"),
        "l_ring": _get_action_handle("/actions/legacy/in/Left_Finger_Ring_Value"),
        "l_pinky": _get_action_handle("/actions/legacy/in/Left_Finger_Pinky_Value"),

        "r_thumb": _get_action_handle("/actions/legacy/in/Right_Finger_Thumb_Value"),
        "r_index": _get_action_handle("/actions/legacy/in/Right_Finger_Index_Value"),
